...
set(NRF_DIR                              C:/Nordic/NCS/v3.4.0/nrf                                        CACHE STRING "nrf folder")
set(NRF_SECURITY_DIR                     C:/Nordic/NCS/v3.4.0/nrf/subsys/nrf_security                    CACHE STRING "nrf_security folder")
set(TFM_BOARDS_NRF_DIR                   C:/Nordic/NCS/v3.4.0/nrf/modules/trusted-firmware-m/tfm_boards  CACHE STRING "tfm_boards folder")
set(ZEPHYR_NRFXLIB_MODULE_DIR            C:/Nordic/NCS/v3.4.0/nrfxlib                      CACHE STRING "nrfxlib folder")
set(ZEPHYR_OBERON_PSA_CRYPTO_MODULE_DIR  C:/Nordic/NCS/v3.4.0/modules/crypto/oberon-psa-crypto            CACHE STRING "oberon-psa-crypto folder")
set(ZEPHYR_MBEDTLS_MODULE_DIR            C:/Nordic/NCS/v3.4.0/modules/crypto/mbedtls                      CACHE STRING "mbedtls folder")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    C:/Nordic/ws_labs/lab3_device_pm/build/lab3_device_pm/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      C:/Nordic/ws_labs/lab3_device_pm/build/lab3_device_pm/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
