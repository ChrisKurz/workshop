...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x0 + 0x0), LENGTH = (1524 * 1024 - 0x0 - 0x0)
...
ASSERT(__nrf_kmu_reserved_push_area == (536870912), "Error:   The section NRF_KMU_RESERVED_PUSH_SECTION needs to be     placed on the top RAM address but it is not, please edit  your linker scripts to make sure that it is placed on     the to RAM address.")
